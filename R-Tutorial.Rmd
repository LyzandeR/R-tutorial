...
I have included the most used functions below but ou can find a more comprehensive vocabulary guide 
here:
...
R in its core is a function programming language, so solid foundation of how functions work is 
